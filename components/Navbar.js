...
const Navbar = () => {
  ...
  return (
    <div>
      {showNavbar && <nav className="bg-white w-[90vw] mx-auto fixed right-[5vw] top-10 rounded-full p-5">
        <div className="flex justify-between items-center">
        <div className="logo flex gap-28 items-center">
          <Link href={"/"}><svg
            className="h-7"
          ...
          <ul className="flex gap-2 justify-center content-center hover:cursor-pointer">
            <Link href={"https://linktr.ee/s/templates/"} target="_blank"><li className="hover:bg-gray-200 px-5 py-2 rounded-lg">Templates</li></Link>
            <Link href={"https://linktr.ee/marketplace"} target="_blank"><li className="hover:bg-gray-200 px-5 py-2 rounded-lg">Marketplace</li></Link>
            <Link href={"https://linktr.ee/s/creator/linktree-for-instagram"} target="_blank"><li className="hover:bg-gray-200 px-5 py-2 rounded-lg">Discover</li></Link>
            <Link href={"https://linktr.ee/s/pricing"} target="_blank"><li className="hover:bg-gray-200 px-5 py-2 rounded-lg">Pricing</li></Link>
            <Link href={"https://linktr.ee/blog/"} target="_blank"><li className="hover:bg-gray-200 px-5 py-2 rounded-lg">Learn</li></Link>
            {/* <Link href={"/generate"}><li className="hover:bg-gray-200 px-5 py-2 rounded-lg">Generate</li></Link> */}
          </ul>
        </div>  
        <div>
          <button className="hover:bg-gray-300 bg-gray-200 text-black px-5 py-2 rounded-lg text-xl">
            Log in
          </button>
          <button className="bg-black text-white px-5 py-2 rounded-full ml-5 text-xl">
            Sign up free
          </button>
        </div>
        </div>
